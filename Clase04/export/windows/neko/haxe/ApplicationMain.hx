...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Clase04", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Clase04";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Clase04", null, { width: 480, height: 432 });
