...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/IntroA.png", "assets/images/IntroA.png");
		type.set ("assets/images/IntroA.png", AssetType.IMAGE);
		path.set ("assets/images/PlayerShoot.png", "assets/images/PlayerShoot.png");
		type.set ("assets/images/PlayerShoot.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/IntroA.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/PlayerShoot.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
